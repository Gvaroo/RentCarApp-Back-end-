...
namespace RentCarApp.Migrations
{
    ...
    [Migration("20230628124022_changedLastUpdatedPropertyToNullable")]
    partial class changedLastUpdatedPropertyToNullable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RentCarApp.Models.Car.RentedCars", b =>
                {
                    b.HasOne("RentCarApp.Models.Car.Cars", "Car")
                        .WithOne("RentedCar")
                        .HasForeignKey("RentCarApp.Models.Car.RentedCars", "CarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
